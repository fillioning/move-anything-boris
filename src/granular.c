...
static int v2_get_param(void *instance, const char *key, char *buf, int buf_len) {
    ...
    if (strcmp(key, "ui_hierarchy") == 0) {
        const char *h = "{"
            "\"modes\":[\"Granular\",\"Randomize\"],"
            "\"levels\":{"
                "\"Granular\":{"
                    "\"label\":\"Granular\","
                    "\"knobs\":[\"density\",\"grain_size\",\"pitch\",\"envelope\","
                        "\"position\",\"drift\",\"wet\",\"freeze\"],"
                    "\"params\":[\"density\",\"grain_size\",\"pitch\",\"envelope\","
                        "\"position\",\"drift\",\"wet\",\"freeze\"]"
                "},"
                "\"Randomize\":{"
                    "\"label\":\"Randomize\","
                    "\"knobs\":[\"random_length\",\"random_delay\",\"random_pitch\","
                        "\"reverse_prob\",\"pan_width\",\"random_vol\",\"chance\",\"feedback\"],"
